...
public class NumerosCPF {
   public static void main(String[] args) {
       Scanner scanner = new Scanner(System.in);

      // O array para guardar os números do CPF que você digitou
      // É útil para ter os dígitos em um formato numérico para cálculos futuros,
      // especialmente para o segundo DV.
      int[] digitosCPF = new int[9]; // Usando int, pois são dígitos de 0 a 9

      // Multiplicadores para o cálculo do PRIMEIRO Dígito Verificador (DV1)
      // Corresponde aos 9 primeiros dígitos do CPF, de 10 a 2
      int[] multiplicadoresDV1 = {10, 9, 8, 7, 6, 5, 4, 3, 2};

      long somaPonderadaDV1 = 0; // Usar long para a soma é uma boa prática para evitar overflow, embora int geralmente seja suficiente aqui.
      ...
      // --- CONVERTER STRING PARA ARRAY DE DÍGITOS E CALCULAR SOMA PONDERADA PARA DV1 ---
      // Este loop faz DUAS coisas:
      // 1. Preenche o array `digitosCPF` com os valores numéricos dos caracteres.
      // 2. Calcula a soma ponderada para o DV1.
